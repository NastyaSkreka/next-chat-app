...
const handleEdit = () => {
  ...
  return (
    <div>
      <div className='flex flex-row gap-5 items-center' onClick={() => setIsModalOpen(true)}>
      ...
      {isModalOpen && (
  <div >
    <div className="fixed inset-0 bg-black opacity-70" onClick={() => setIsModalOpen(false)}></div>
